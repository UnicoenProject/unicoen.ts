...
import { TranslationunitContext } from './Python3Parser';
...
import { StmtsContext } from './Python3Parser';
...
import { Expr_stmt_rightContext } from './Python3Parser';
import { Test_star_exprContext } from './Python3Parser';
import { Testlist_star_expr_arrayContext } from './Python3Parser';
...
import { ArrayContext } from './Python3Parser';
import { IdentContext } from './Python3Parser';
import { BoolContext } from './Python3Parser';
import { Testlist_compContext } from './Python3Parser';
import { TrailerContext } from './Python3Parser';
import { Method_call_of_method_returnContext } from './Python3Parser';
import { Method_call_no_argContext } from './Python3Parser';
import { Method_callContext } from './Python3Parser';
import { Array_accessContext } from './Python3Parser';
import { Field_accessContext } from './Python3Parser';
...
import { Testlist_arrayContext } from './Python3Parser';
...
import { FloatContext } from './Python3Parser';
import { ImaginaryContext } from './Python3Parser';
...
export interface Python3Visitor<Result> extends ParseTreeVisitor<Result> {
  /**
   * Visit a parse tree produced by `Python3Parser.translationunit`.
  ...
  /**
   * Visit a parse tree produced by `Python3Parser.stmts`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  ...
  /**
   * Visit a parse tree produced by `Python3Parser.expr_stmt_right`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  visitExpr_stmt_right?: (ctx: Expr_stmt_rightContext) => Result;
   ...
   * @return the visitor result
   */
  visitTest_star_expr?: (ctx: Test_star_exprContext) => Result;

  /**
   * Visit a parse tree produced by `Python3Parser.testlist_star_expr_array`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  visitTestlist_star_expr_array?: (ctx: Testlist_star_expr_arrayContext) => Result;
  ...
  /**
   * Visit a parse tree produced by `Python3Parser.ident`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  ...
  /**
   * Visit a parse tree produced by `Python3Parser.bool`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  ...
  /**
   * Visit a parse tree produced by `Python3Parser.method_call_of_method_return`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  visitMethod_call_of_method_return?: (ctx: Method_call_of_method_returnContext) => Result;

  /**
   * Visit a parse tree produced by `Python3Parser.method_call_no_arg`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  visitMethod_call_no_arg?: (ctx: Method_call_no_argContext) => Result;

  /**
   * Visit a parse tree produced by `Python3Parser.method_call`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  ...
  /**
   * Visit a parse tree produced by `Python3Parser.array_access`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  ...
  /**
   * Visit a parse tree produced by `Python3Parser.field_access`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  visitField_access?: (ctx: Field_accessContext) => Result;
  ...
  /**
   * Visit a parse tree produced by `Python3Parser.testlist_array`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  visitTestlist_array?: (ctx: Testlist_arrayContext) => Result;
  ...
  /**
   * Visit a parse tree produced by `Python3Parser.float`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  ...
  /**
   * Visit a parse tree produced by `Python3Parser.imaginary`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  visitImaginary?: (ctx: ImaginaryContext) => Result;
}
