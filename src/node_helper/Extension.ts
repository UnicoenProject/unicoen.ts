...
if (Array.prototype.isEmpty) {
  console.warn(
    "Overriding existing Array.prototype.isEmpty. Possible causes: New API defines the method, there's a framework conflict or you've got double inclusions in your code.",
  );
}
...
if (Array.prototype.remove) {
  console.warn(
    "Overriding existing Array.prototype.remove. Possible causes: New API defines the method, there's a framework conflict or you've got double inclusions in your code.",
  );
}
...
if (Map.prototype.containsKey) {
  console.warn(
    "Overriding existing Map.prototype.containsKey. Possible causes: New API defines the method, there's a framework conflict or you've got double inclusions in your code.",
  );
}
...
if (Map.prototype.containsValue) {
  console.warn(
    "Overriding existing Map.prototype.containsValue. Possible causes: New API defines the method, there's a framework conflict or you've got double inclusions in your code.",
  );
}
