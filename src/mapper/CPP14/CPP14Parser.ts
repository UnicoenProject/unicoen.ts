...
export class CPP14Parser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		...
		"myclassspecifier", "myclassspecifierstatement", "myclasshead", "declaration", 
		"blockdeclarationwithoutsimpledeclaration", "blockdeclaration", "aliasdeclaration", 
		"variabledeclarationstatement", "variabledeclaration", "structspecifier", 
		"variableDeclaratorList", "variableDeclarator", "dims", "functiondeclarationstatement", 
	...
	public myclassspecifierstatement(): MyclassspecifierstatementContext {
		let _localctx: MyclassspecifierstatementContext = new MyclassspecifierstatementContext(this._ctx, this.state);
...
export class MyclassspecifierstatementContext extends ParserRuleContext {
	...
	@Override public get ruleIndex(): number { return CPP14Parser.RULE_myclassspecifierstatement; }
	@Override
	public accept<Result>(visitor: CPP14Visitor<Result>): Result {
		if (visitor.visitMyclassspecifierstatement) return visitor.visitMyclassspecifierstatement(this);
		else return visitor.visitChildren(this);
	}
}
