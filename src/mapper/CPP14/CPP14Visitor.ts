...
import { IdentexpressionContext } from './CPP14Parser';
...
import { IdexpressionlapperContext } from './CPP14Parser';
import { FunctioncallexpressionContext } from './CPP14Parser';
...
import { BinaryexpressionContext } from './CPP14Parser';
import { UnaryexpressionContext } from './CPP14Parser';
import { TypeidlapperContext } from './CPP14Parser';
...
import { EnhancedForStatementContext } from './CPP14Parser';
...
import { BreakStatementContext } from './CPP14Parser';
import { ContinueStatementContext } from './CPP14Parser';
import { ReturnStatementContext } from './CPP14Parser';
...
import { DeclspecifierwithouttypeContext } from './CPP14Parser';
import { DeclspecifierseqwithouttypeContext } from './CPP14Parser';
...
import { TypenameContext } from './CPP14Parser';
...
import { TypeidContext } from './CPP14Parser';
...
import { FunctionheaderContext } from './CPP14Parser';
import { FunctiondeclaratorContext } from './CPP14Parser';
...
import { MyclassnameContext } from './CPP14Parser';
import { ClassspecifierContext } from './CPP14Parser';
import { ClassbodyContext } from './CPP14Parser';
...
import { MembervariabledeclarationstatementContext } from './CPP14Parser';
import { MembervariabledeclarationContext } from './CPP14Parser';
...
import { OperatorContext } from './CPP14Parser';
import { LiteralContext } from './CPP14Parser';
import { IntegerliteralContext } from './CPP14Parser';
import { CharacterliteralContext } from './CPP14Parser';
import { FloatingliteralContext } from './CPP14Parser';
import { StringliteralContext } from './CPP14Parser';
...
export interface CPP14Visitor<Result> extends ParseTreeVisitor<Result> {
   ...
   * @return the visitor result
   */
  visitIdexpressionlapper?: (ctx: IdexpressionlapperContext) => Result;
   ...
   * @return the visitor result
   */
  visitTypeidlapper?: (ctx: TypeidlapperContext) => Result;
   ...
   * @return the visitor result
   */
  visitStatementWithoutLabeldstatementseq?: (
    ctx: StatementWithoutLabeldstatementseqContext,
  ) => Result;
   ...
   * @return the visitor result
   */
  visitMyclassbody?: (ctx: MyclassbodyContext) => Result;
   ...
   * @return the visitor result
   */
  visitMyclasshead?: (ctx: MyclassheadContext) => Result;
   ...
   * @return the visitor result
   */
  visitBlockdeclarationwithoutsimpledeclaration?: (
    ctx: BlockdeclarationwithoutsimpledeclarationContext,
  ) => Result;
   ...
   * @return the visitor result
   */
  visitDeclspecifierwithouttype?: (ctx: DeclspecifierwithouttypeContext) => Result;
   ...
   * @return the visitor result
   */
  visitDeclspecifierseqwithouttype?: (ctx: DeclspecifierseqwithouttypeContext) => Result;
   ...
   * @return the visitor result
   */
  visitMyclassname?: (ctx: MyclassnameContext) => Result;
   ...
   * @return the visitor result
   */
  visitMembervariabledeclarationstatement?: (
    ctx: MembervariabledeclarationstatementContext,
  ) => Result;
   ...
   * @return the visitor result
   */
  visitMembervariabledeclaration?: (ctx: MembervariabledeclarationContext) => Result;
