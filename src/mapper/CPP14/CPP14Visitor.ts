...
export interface CPP14Visitor<Result> extends ParseTreeVisitor<Result> {
	 ...
	 * @return the visitor result
	 */
	visitBlockdeclarationwithoutsimpledeclaration?: (ctx: BlockdeclarationwithoutsimpledeclarationContext) => Result;
	 ...
	 * @return the visitor result
	 */
	visitMembervariabledeclarationstatement?: (ctx: MembervariabledeclarationstatementContext) => Result;
